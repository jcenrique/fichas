...
<body>
    <div class="flex justify-between  h-20 bg-gray-300 text-gray-800  border-b-1 border-gray-200 p-2 mb-2">
        <div>

            <img src="{{ url('/img/miLogo.png') }}" alt="" title="" width=""></a>
        ...
        <div class="top-0 right-0 px-6 py-4 sm:block ">
            ...
            @else
                <a href="{{ route('login') }}" class="text-sm text-gray-800 underline">{{__('Log in')}}</a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-800 underline">{{__('Register')}}</a>
                @endif
            @endauth
        </div>
        @endif
...
<div class="container-fluid" data-controller="@yield('controller')" @yield('controller-data')>
    ...
    <div class="row">
        ...
        <div class="col overflow-hidden bg-gray-100">
